-- Included from idris-contrib (https://github.com/idris-lang/Idris2/blob/main/libs/contrib/Data/SortedMap/Dependent.idr)
-- This is only included directly because I couldn't figure out how to import the package.
